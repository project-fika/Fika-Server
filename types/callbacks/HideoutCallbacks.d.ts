...
export declare class HideoutCallbacks implements OnUpdate {
     ...
     */
    circleOfCultistProductionStart(pmcData: IPmcData, request: IHideoutCircleOfCultistProductionStartRequestData, sessionId: string): IItemEventRouterResponse | PromiseLike<IItemEventRouterResponse>;
